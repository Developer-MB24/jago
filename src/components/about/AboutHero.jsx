...
export default function AboutHero() {
  return (
    ...
    >
      ...
      {/* === SOCIAL ICONS – ABSOLUTE INSIDE HERO (not fixed) === */}
      <div
        className="
        ...
        {[
          ...
          <button
            ...
            className="
              ...
              text-[10px]
              shadow-sm
              hover:bg-[#004540] hover:text-white
              transition
            "
          >
            {Icon}
      ...
      <div className="max-w-6xl mx-auto px-4 lg:px-12 py-20 lg:py-24 flex flex-col lg:flex-row items-stretch">
        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-center">
          {/* one max-width wrapper so subtitle == content width */}
          <div className="max-w-xl">
            ...
            >
              <img
                ...
                className="w-7 h-7"
              />
              <span className="text-[#004540] text-sm font-medium">
            ...
            {/* Paragraph */}
            <p
              className="mt-6 text-gray-600 text-[16px] sm:text-[18px] leading-[1.6]"
              data-aos="fade-up"
              data-aos-delay="600"
              data-aos-duration="1000"
            >
            ...
            >
              ...
              <div className="flex flex-col">
                <div className="flex items-center gap-3">
                  <span className="flex items-center gap-1 text-sm text-[#004540] font-semibold">

    ...
    <>
      <style>{`
        ...
        .services-two__slide {
          ...
          flex-wrap: nowrap; /* keep 4 cards in a row */
        }
        ...
        .services-two__single {
          ...
          flex-direction: column;  /* image + content stack */
          width: 100%;
          max-width: 300px;
          height: 100%;
        }
        ...
        .services-two__img {
          position: relative;
          display: block;
          /* mask left empty; you can paste SVG data URL if needed */
  ...
  .services-two__single {
    ...
    max-width: 100%;
        ...
        .services-two__text {
          ...
          font-size: 14px;
          color: #6b7280;
          flex: 1;       /* stretch to help equal height */
        }
        ...
        .services-two__dot-inner {
          ...
          height: 20px;
          border-radius: 999px;
          background-color: rgba(255, 153, 51, 0.25); /* outer ring */
          display: flex;
          align-items: center;
          justify-content: center;
        }
        ...
        .services-two__dot-center {
          ...
          height: 10px;
          border-radius: 999px;
          background-color: #FF9933; /* inner dot */
          opacity: 0.6;
          transform: scale(0.9);
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mb-10 text-center">
            ...
            <h2 className="text-3xl font-semibold leading-snug text-slate-900 sm:text-4xl md:text-5xl">
              ...
              <span className="block text-[#EB5757]">Service Now</span>
            </h2>
          </div>

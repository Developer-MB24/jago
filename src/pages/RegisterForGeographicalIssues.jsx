...
// Geographical Issues education dropdown
const educationOptions = [
  "BA / MA Geography",
  "B.Sc / M.Sc Environmental Studies",
  "Geology (B.Sc / M.Sc)",
  ...
  "Climate Change Awareness Certification",
  "Other (Specify)",
];
...
const RegisterForGeographicalIssues = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    whyVolunteerGeo: "",
    commonIssues: "",
    fieldSurveysExperience: "",
    familiarClimate: "",
    diagnoseRootCause: "",
    comfortableFieldVisits: "",
    toolsExperience: "",
    helpCommunityLivelihood: "",
    disasterReliefExperience: "",
    comfortableInteractingVillagers: "",
    geoMotivation: "",
  ...
  const handleSubmit = (e) => {
    ...
    if (!isBothVerified()) {
      alert("Please verify both Mobile Number and Aadhaar OTP.");
      return;
    }

    if (!formData.msgConsent) {
      alert("Please agree to receive messages/communication.");
      return;
    }
    ...
    console.log("Geographical Issues form submitted:", formData, files);
  ...
  const steps = [
    ...
    { id: 3, title: "Geographical Issues & Submit" },
  ];
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-4xl bg-white/90 rounded-2xl shadow-xl mt-20 p-6 md:p-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    {formData.education === "Other (Specify)" && (
                      <input
                        type="text"
                        name="otherEducation"
          ...
          {currentStep === 3 && (
            <>
              {/* Geographical Issues Questions */}
              <div>
                <h2 className="text-lg font-semibold text-slate-800 mb-4">
                  Geographical / Environmental Experience & Motivation
                </h2>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-1">
                      ...
                      Geographical Issues Program?{" "}
                      <span className="text-red-500" aria-hidden="true">
                        *
                      </span>
                    </label>
                    <textarea
                      name="whyVolunteerGeo"
                      required
                      rows={3}
                      className="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#138808]"
                      value={formData.whyVolunteerGeo}
                      onChange={handleChange}
                    />
                    <p className="text-xs text-slate-500 mt-1">
                      Maximum 120 words.
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-1">
                      What geographical or environmental issues are most common
                      in your area (e.g., water scarcity, soil erosion,
                      pollution, waste management)? Please describe.{" "}
                      <span className="text-red-500" aria-hidden="true">
                        *
                      </span>
                    </label>
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-1">
                      Have you ever worked on any field-related surveys,
                      environmental activities, or community mapping? If yes,
                    ...
                    <textarea
                      name="fieldSurveysExperience"
                      required
                      rows={3}
                      className="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#138808]"
                      value={formData.fieldSurveysExperience}
                      onChange={handleChange}
                    />
                    <p className="text-xs text-slate-500 mt-1">
                      Maximum 120 words.
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-1">
                      How familiar are you with climate change, natural
                      disasters, or environmental impact in rural or urban
                      areas?{" "}
                      <span className="text-red-500" aria-hidden="true">
                        *
                      </span>
                    ...
                    <textarea
                      name="familiarClimate"
                      required
                      rows={3}
                      className="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#138808]"
                      value={formData.familiarClimate}
                      onChange={handleChange}
                    />
                    <p className="text-xs text-slate-500 mt-1">
                      Maximum 120 words.
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-1">
                      If you notice a geographical issue in a community (such as
                      drainage problems, deforestation, or land degradation),
                    ...
                    <textarea
                      ...
                      rows={3}
                      className="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#138808]"
                      value={formData.diagnoseRootCause}
                      onChange={handleChange}
                    />
                    <p className="text-xs text-slate-500 mt-1">
                      Maximum 120 words.
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-1">
                      Are you comfortable participating in field visits,
                      surveys, awareness drives, or community-based research?{" "}
                      <span className="text-red-500" aria-hidden="true">
                        *
                      </span>
                    </label>
                    <textarea
                      name="comfortableFieldVisits"
                      required
                      rows={3}
                      className="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#138808]"
                      value={formData.comfortableFieldVisits}
                      onChange={handleChange}
                    />
                    <p className="text-xs text-slate-500 mt-1">
                      Maximum 120 words.
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-1">
                      Do you have experience using tools like basic mapping,
                      GPS, mobile survey apps, or environmental monitoring
                      equipment?{" "}
                      <span className="text-red-500" aria-hidden="true">
                        *
                      </span>
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-1">
                      How would you help a community understand the impact of
                      geographical issues on their livelihood?{" "}
                      <span className="text-red-500" aria-hidden="true">
                        *
                      </span>
                    </label>
                    <textarea
                      name="helpCommunityLivelihood"
                      required
                      rows={3}
                      className="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#138808]"
                      value={formData.helpCommunityLivelihood}
                      onChange={handleChange}
                    />
                    <p className="text-xs text-slate-500 mt-1">
                      Maximum 120 words.
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-1">
                      Have you ever participated in any disaster relief, flood
                      management, or emergency preparedness training?{" "}
                      <span className="text-red-500" aria-hidden="true">
                        *
                      </span>
                    </label>
                    <textarea
                      name="disasterReliefExperience"
                      required
                      rows={3}
                      className="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#138808]"
                      value={formData.disasterReliefExperience}
                      onChange={handleChange}
                    />
                    <p className="text-xs text-slate-500 mt-1">
                      Maximum 120 words.
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-1">
                      Are you comfortable interacting with villagers or local
                      communities to gather information about environmental or
                    ...
                    <textarea
                      name="comfortableInteractingVillagers"
                      required
                      rows={3}
                      className="w-full border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#138808]"
                      value={formData.comfortableInteractingVillagers}
                      onChange={handleChange}
                    />
                    <p className="text-xs text-slate-500 mt-1">
                      Maximum 120 words.
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-1">
                      What motivates you to work on geographical or
                      environmental issues, and how do you wish to contribute
                      through Jaago Manav?{" "}
                      <span className="text-red-500" aria-hidden="true">
                        *
                      </span>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          <div className="bg-white rounded-2xl shadow-xl p-6 max-w-sm w-full text-center animate-fadeIn">
            ...
            <p className="text-sm text-slate-700 mb-6">
              Your Geographical Issues volunteer registration has been submitted
              successfully.
            </p>
            ...
            <button
              ...
              className="inline-flex justify-center rounded-full bg-[#138808] px-6 py-2 text-sm font-semibold text-white hover:bg-[#0f6d06]"
            >
              OKAY
            </button>
          </div>
...
export default RegisterForGeographicalIssues;

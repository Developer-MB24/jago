...
const RegisterForAgriculture = () => {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: "url('/images/agriculture.png')",
      }}
    >
      {/* <div className="absolute inset-0 bg-[#fef6e8]/60 pointer-events-none"></div> */}

      <div className="relative z-10 w-full max-w-4xl bg-white/90 rounded-2xl shadow-xl p-6 mt-20 md:p-10">
        {/* Heading */}
        <h1
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          <div className="bg-white rounded-2xl shadow-xl p-6 max-w-sm w-full text-center animate-fadeIn">
            ...
            <p className="text-sm text-slate-700 mb-6">
              Your Agriculture Program volunteer registration has been submitted
              successfully.
            </p>
